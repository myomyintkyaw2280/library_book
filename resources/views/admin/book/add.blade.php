...
@section('title', translate('add_new_book'))
@section('css')
@endsection
	...
	<div class="row">
	    <div class="col-6 mx-auto">
	        <div class="card">
	            ...
	            <div class="card-body">
	                <form class="form-horizontal" method="POST" action="{{ route('books.update') }}" enctype='multipart/form-data'>
	                    @csrf
	                    
	                    <div class="form-group">
	                        <label for="title" class="col-sm-4 pl-0 control-label"><?php echo translate('book_name') ?></label>
	                        <input type="text" class="form-control" id="title" placeholder="<?php echo translate('book_name') ?>" name="title" value=""  required>
	                    </div> 
	                    ...
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="barcode" placeholder="<?php echo translate('book_barcode') ?>" name="barcode" value=""
	                            required>
	                    </div> 
	                    ...
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="isbn_no" placeholder="<?php echo translate('isbn_no') ?>" name="isbn_no" value="" >
	                    </div>

	                    <div class="form-group">
	                        <label for="publisher" class="col-sm-4 pl-0 control-label"><?php echo translate('publisher') ?></label>
	                        <input type="text" class="form-control" id="publisher" placeholder="<?php echo translate('publisher') ?>" name="publisher" value="" >
	                    </div>

	                    <div class="form-group">
	                        <label for="author" class="col-sm-4 pl-0 control-label"><?php echo translate('author') ?></label>
	                        <input type="text" class="form-control" id="author" placeholder="<?php echo translate('author') ?>" name="author" value="" >
	                    </div>

	                    <div class="form-group">
	                        <label for="published_date" class="col-sm-4 pl-0 control-label"><?php echo translate('published_date') ?></label>
	                        <input type="date"  class="form-control" id="published_date" placeholder="<?php echo translate('published_date') ?>" name="published_date" value="" >
	                    </div>
	                    <div class="form-group">
	                        <label for="total_page" class="col-sm-4 pl-0 control-label"><?php echo translate('total_page') ?></label>
	                        <input type="number" min="1" step="1"  class="form-control" id="total_page" placeholder="<?php echo translate('total_page') ?>" name="total_page" value="" >
	                    </div>
	                    <div class="form-group">
	                        <label for="language" class="col-sm-4 pl-0 control-label"><?php echo translate('language') ?></label>
	                        <input type="text" class="form-control" id="language" placeholder="<?php echo translate('language') ?>" name="language" value="" >
	                    </div>

	                    <div class="form-group">
	                        <label for="overview" class="col-sm-4 pl-0 control-label"><?php echo translate('overview') ?></label>
	                        <textarea class="form-control" id="overview"  stack-note placeholder="<?php echo translate('overview') ?>" name="overview"></textarea>
	                    </div>
